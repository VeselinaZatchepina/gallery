...
class DialogDeletePhotoFromAllPhotosActivity : DialogFragment() {
    ...
    companion object {
        ...
        fun newInstance(photoPath: String): DialogDeletePhotoFromAllPhotosActivity {
            val bundle = Bundle()
            bundle.putString(PHOTO_PATH_DIALOG_BUNDLE, photoPath)
            val fragment = DialogDeletePhotoFromAllPhotosActivity()
    ...
    private fun deletePhoto() {
        photosViewModel.deleteMyPhoto(photoPathForDelete,
